...
namespace SIRERH.Models
{
    public class USUARIOsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_USUARIO,NOMBRE,APELLIDO1,APELLIDO2,EDAD,CORREO,TELEFONO,SEXO,CEDULA,USUARIO1,PASSWORDS,TIPO_USUARIO,ESTADO")] USUARIO uSUARIO)
        {
            if (ModelState.IsValid)
            {
